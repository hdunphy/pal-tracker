...
public class JdbcTimeEntryRepository implements TimeEntryRepository {
    ...
    public TimeEntry update(long id, TimeEntry toUpdate) {
        String query = "UPDATE time_entries SET project_id = ?, user_id = ?, date = ?, hours = ? " +
                "WHERE id = ?";
        jdbcTemplate.update(query, toUpdate.getProjectId(), toUpdate.getUserId(),
        toUpdate.getDate(), toUpdate.getHours(), id);
        return find(id);
    }
